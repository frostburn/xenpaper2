...
[ '0 4 7 ]--- [ 0 3 7 10 ]---`,
  ...
  },
  {
    ...
    demos: [
      ...
      {
        description:
          'Use ? on the target to make it zero-duration. Easing modes include linear, ease, ease-in/out/in-out, plus sine, quad, cubic, quart, quint, expo, circ, overshoot, and bounce variants.',
