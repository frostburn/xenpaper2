  ...
  |    ^`,
    ...
    describe('setters', () => {
        ...
        expect(
        ...
        ).toEqual([
          {
            ...
            setters: [
              ...
              { type: 'Semicolon' },
              { type: 'SetVelocity', velocity: 0.1 },
              { type: 'Semicolon' },
              { type: 'SetVelocity', velocity: 0.2 },
              { type: 'Semicolon' },
              { type: 'SetVelocity', velocity: 0.3 },
              { type: 'Semicolon' },
              { type: 'SetVelocity', velocity: 0.4 },
              { type: 'Semicolon' },
              { type: 'SetVelocity', velocity: 0.5 },
              { type: 'Semicolon' },
      ...
      it('should error if setter is empty or not delimited properly', () => {
        expectParserErrorMessage(
          '()',
          'Expected "/", "^", "al", "bms", "bpm", "coda", "cresc", "d", "da", "dal", "dim", "div", "drone", "env", "f", "ff", "fff", "fine", "gliss", "grace", "groove", "key", "mf", "mp", "noise", "osc", "p", "plot", "pp", "ppp", "rl", "segno", "sig", "to", "vel", "vol", or integer but ")" found.',
        )
    ...
    it('should parse glissando setters and zero-duration targets', () => {
      ...
      expect(strip(parser('(cresc ease-in-out; dim EASE-OUT)').sequence.items[0])).toMatchObject({
        type: 'SetterGroup',
        setters: [
